...
from modules.DiagnosticsBMW.b_DiagnosticsBMW import BaseDiagnosticsBMW
...
# Naming Rule: a_name
class AbstractDiagnosticsBMW(GenericApp):
    # ------------------------------------------------------------------------------------------------------------------
    # Mandatory Inputs
    # ------------------------------------------------------------------------------------------------------------------
    PATH_INPUTS = []
    ...
    def __init__(self, tool_config=None, run_args=None):
        ...
        super(AbstractDiagnosticsBMW, self).__init__()
    ...
    def interface_init(self, args=None):
        ...
        self.base_module = BaseDiagnosticsBMW(
            attr1="some_path",
            attr2="351",
            attr3=None
        )
